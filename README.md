...
## 📖 Descrição
O **MediFinder** é um sistema de consulta de medicamentos que permite aos usuários fazer o **upload de receitas médicas em PDF**. Utilizando **Tesseract OCR**, o sistema extrai informações do documento e verifica a disponibilidade dos medicamentos no estoque. 
